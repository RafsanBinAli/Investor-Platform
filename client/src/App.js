...
import StartupBody from "./components/StartupShow/StartupInfoBody/startupBody";
		...
		<>
			<Router>
				...
				<Routes>
					...
					<Route path="startup/signup" element={<Reg />} />

...
import Registration from "../InvestorRegistration/Registration";
				...
				<div className="Home-main">
					...
					<div className="join">
						...
						<div className="button">
							<Link to='/login'> <button className="join-button">Investor</button> </Link>

							<Link to='/startup/login'> <button className="join-button">StartUp Manager</button> </Link>
